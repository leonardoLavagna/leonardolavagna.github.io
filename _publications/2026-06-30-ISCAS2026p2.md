...
excerpt: 'We develop a unified circuit framework that models quantum advice effects on symmetric cryptosystems, introducing a controllable quantum-channel interaction between system and environment registers. The resulting non-isolated circuits exhibit additive time-space behavior, instead of standard multiplicative scaling'
date: 2026-06-30
